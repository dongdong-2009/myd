...
#define RX_PLOAD_WIDTH  1  // 1 bytes TX payload

typedef unsigned char BYTE;
typedef unsigned char uchar;
//****************************************************************//
// SPI(nRF24L01) commands
#define NRF24L01_READREG        0x00  // Define read command to register
#define NRF24L01_WRITEREG       0x20  // Define write command to register
...
// void SPI_Init(BYTE Mode);     // Init HW or SW SPI
 void SPI1_Config(void);                            /*SPI1 Module configuration   */
...
uchar SPI_Write_Buf(BYTE reg,const BYTE *pBuf, BYTE bytes);  // Writes multiply bytes to one register
...
void nRF24L01_TxPacket(const unsigned char * tx_buf);


extern BYTE const TX_ADDRESS[TX_ADR_WIDTH];//TX address
extern BYTE const RX_ADDRESS[RX_ADR_WIDTH];//;RX address
